...
export default function DevelopersPage() {
  ...
  const [docSection, setDocSection] = useState<'intro' | 'auth' | 'hmac' | 'checkout' | 'sdk' | 'endpoints' | 'webhooks' | 'testing'>('intro');
  ...
  onClose: () => console.log('Modal cerrado'),
            ...
            {docSection === 'webhooks' && (
              <div className="space-y-5">
                ...
                <p>
                  Los webhooks permiten recibir actualizaciones del estado de un pago de forma asíncrona. Cada vez que una transacción cambia de estado, Consi envía una petición <code className="bg-[var(--ink-100)] px-1 rounded font-mono text-xs">POST</code> firmada a la URL que configuraste en <strong>Claves y Webhooks</strong>.
                </p>

                {/* Flow steps */}
                <div className="grid grid-cols-1 gap-2">
                  {[
                    { n: '1', t: 'Configura tu URL', d: 'Registra tu endpoint HTTPS público en la pestaña Claves y Webhooks.' },
