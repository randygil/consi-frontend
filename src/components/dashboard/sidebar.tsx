...
export const MERCHANT_NAV = [
  ...
  { href: '/payouts', label: 'Retiros', icon: Banknote, keywords: 'payout sacar banco cuenta liquidacion dispersion automatico convertir fx' },
  { href: '/settlements', label: 'Retenciones', icon: Wallet, keywords: 'retencion liberacion settlement liquidacion fondos congelados reserva' },
